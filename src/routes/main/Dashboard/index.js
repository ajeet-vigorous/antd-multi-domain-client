...
const Dashboard = () => {
  ...
  return (
    ...
    ) : (settings.domainName === "DRX100" || settings.domainName === "JEM29" || settings.domainName === "RACEX9" || settings.domainName === "LION99" || settings.domainName === "BALAJI12" || settings.domainName === "STAR99" || settings.domainName === "Allbets24" || settings.domainName === "2xbat") ? (
