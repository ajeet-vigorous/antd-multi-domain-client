...
const LoadingScreen = () => {
  return (
    <div className='avaitor-contener'>
      <div className="main-loading">
        <div className="main-loading-powered-by">
          <div className="main-loading-powered-by-base64"></div>
        </div>
        <div className="main-loading-logo main-loading-logo-base64"></div>
    ...
    .avaitor-contener {
        ...
        .main-loading-powered-by-base64 {
                background-image: url(data:image/png;base64,);
                width: 80px;
                height: 10px;
