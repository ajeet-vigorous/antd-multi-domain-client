...
const CanvasAnimation = memo(({ stateRef, games, initialGameStatus }) => {
    ...
    useEffect(() => {
        ...
        function draw(
            ...
            // else {
            //   console.error(
            //     "Error: The spritesheet image is not fully loaded or is broken."
            //   );
            // }
        }
        function GameObject(
        ...
        // console.log(bettingPhase, "hhhhhhhhhhhh");
    ...
    return (
        <>    <canvas ref={canvasRef} id="myCanvas" height={400} width={1900} style={{
            cursor: 'pointer',
