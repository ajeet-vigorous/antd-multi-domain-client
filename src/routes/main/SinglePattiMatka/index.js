...
const SinglePattiMatka = () => {
  ...
  return (
    <>
      ...
      <Typography style={{ color: "#26122D" }} className=" gx-fs-xxl gx-font-weight-heavy gx-text-center gx-my-3 gx-text-uppercase">{ismatkaList?.name ? ismatkaList?.name : '-' }-SINGLE-PATTI</Typography>
      <Row justify={"center"}>
